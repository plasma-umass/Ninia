...
var testList = [
    ...
    ["NameError testSRP()", "pytests/caught_exceptions/nameError"],
    ...
    ["Raising with message uncaught", "pytests/uncaught_exceptions/raiseMultipleArg"],
    ["User-defined exception class", "pytests/uncaught_exceptions/userClassException"],
    [`\n--- Thread tests ---`],

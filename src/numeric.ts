...
export class Py_Long extends pytypes.Py_Object implements IPy_Number {
    value: Decimal;
...
export class Py_Float extends pytypes.Py_Object implements IPy_Number {
...
// number as a Complex.
export class Py_Complex extends pytypes.Py_Object implements IPy_Number {
